...
public class UpdateTeamServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateTeamServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateTeamServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        team.setGroupName(request.getParameter("groupname"));
